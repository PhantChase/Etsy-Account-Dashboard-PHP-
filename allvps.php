<?php 
	if (isset($_POST['addvps']))
        ...
        $vpsname = trim(addslashes(strtolower($_POST['vpsname'])));
        $password = trim(addslashes(strtolower($_POST['password'])));
        $etsyname = addslashes(trim($_POST['etsyname']));
        $type = addslashes(trim($_POST['type']));
        
        $sql = "INSERT INTO `vps` (`id`, `vpsname`, `password`, `etsyname`, `type`) VALUES (NULL, '".$vpsname."', '".$password."', '', '".$type."')";
      ...
      <main role="main" class="main-content">
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-12">
              <h2 class="mb-2 page-title">All VPS</h2>
                    ...
                    <div class="card-body">
                      ...
                      <table class="table datatables" id="dataTable-1">
                        ...
                        <tbody>
                            ...
                            <?php 
                            include('connectdb.php');
              $sql = "SELECT * FROM `vps` ORDER BY id DESC";
                               ...
                               if ($result->num_rows > 0) {
                                  ...
                                  while($row = $result->fetch_assoc()) {
                                    ...
                                    echo '
                                      ...
                                      <tr>
                                      <td><a href="editvps.php?id='.$row["id"].'" "><i class="fe fe-eye fe-16"></i></a></td>
                                      <td>
                                        '.$row["id"].'
                                      </td>
                    ...
                    if($row["used"] == '0'){
                      echo'<td><span class="dot dot-lg bg-success mr-2"></span>Chưa dùng</td>';
                    };
                    if($row["used"] == '1'){
                      echo'<td><span class="dot dot-lg bg-warning mr-2"></span>Đã dùng</td>';
                    };
                    ...
                    <td><a href="#" onclick="'; echo"CopyToClipboard('etsyname".$row["id"]."')"; echo ';return false;"><i class="fe fe-copy fe-16"></i></a></td>
                    <td id="etsyname'.$row["id"].'">'.$row["etsyname"].'</td>';
                    ...
                    if($row["type"] == '2'){
                      echo'<td><span class="dot dot-lg bg-danger mr-2"></span>Siêu Mạnh</td>';
                    };
