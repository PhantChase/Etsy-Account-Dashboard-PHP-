...
if (isset($_POST["submit"]))
{
    ...
    else
    {
        ...
        $sql = "UPDATE `po` SET `email` = '" . $email . "', `password` = '" . $password . "', `emailkp` = '" . $emailkp . "', `passwordpo` = '" . $passwordpo . "', `phone` = '" . $phone . "', `cccd` = '" . $cccd . "', `stk` = '" . $stk . "', `ch1` = '" . $ch1 . "', `ch2` = '" . $ch2 . "', `ch3` = '" . $ch3 . "', `tl1` = '" . $tl1 . "', `tl2` = '" . $tl2 . "', `tl3` = '" . $tl3 . "', `bankname` = '" . $bankname . "', `bankaddress` = '" . $bankname . "', `accounttype` = '" . $accounttype . "', `routing` = '" . $routing . "', `accountnumber` = '" . $accountnumber . "', `beneficiaryname` = '" . $beneficiaryname . "', `active` = '', `used` = '" . $used . "' WHERE `po`.`id` = " . $id . "";
         ...
         <?php
            include('connectdb.php');
                           ...
                           if ($result->num_rows > 0) {
                              ...
                              while($row = $result->fetch_assoc()) {
                                ...
                                echo '
            <h2 class="page-title">'.$row["beneficiaryname"].'</h2>
            <div class="row mt-5 align-items-center">
            <div class="col-md-3 text-center mb-5">
              <div class="avatar avatar-xl">
                <img src="./'.$row["img"].'" alt="..." class="avatar-img rounded-circle" style="height: 110px;">
              </div>
            </div>
            <div class="col">
              <div class="row align-items-center">
                <div class="col-md-7">
                  <h4 class="mb-1">'.$row["email"].'</h4>
              ...
              <div class="row mb-4">
                ...
                <div class="col">
                  <p class="small mb-0 text-muted">'.$row["cccd"].'</p>
                  <p class="small mb-0 text-muted">Account number: '.$row["accountnumber"].'</p>
                  <p class="small mb-0 text-muted">'.$row["phone"].'</p>
                </div>
              </div>
            </div>
            </div>
                ...
                <form method="post" enctype="multipart/form-data" action="">
                  <div class="form-row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="email" name="email" value="'.$row["email"].'" class="form-control" id="inputEmail4" placeholder="Email">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="inputPassword4">Password *</label>
                      <input type="text" name="password" value="'.$row["password"].'" class="form-control" id="inputPassword4" placeholder="Password">
                    </div>
                  </div>
                  <div class="form-row">
                    <div class="form-group col-md-6">
                      <label for="inputEmail4">Email khôi phục *</label>
                      <input type="email" name="emailkp" value="'.$row["emailkp"].'" class="form-control" id="inputEmail4" placeholder="Email">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="inputPassword4">Password PO *</label>
                      <input type="password" value="'.$row["passwordpo"].'" name="passwordpo" class="form-control" id="inputPassword4" placeholder="Password">
                    </div>
                  </div>
                  <div class="form-row">
                  <div class="form-group col-md-4">
                    <label for="inputPhoneUS">Phone *</label>
                    <input type="text" name="phone" value="'.$row["phone"].'" class="form-control input-phone" id="inputAddress" placeholder="(124) 035-6451">
                  </div>
                  <div class="form-group col-md-4">
                    <label for="inputPhoneUS">CCCD *</label>
                    <input type="text" name="cccd" value="'.$row["cccd"].'" class="form-control input-number" id="inputAddress" placeholder="033177000374">
                  </div>
                  <div class="form-group col-md-4">
                    <label for="inputNumber">STK *</label>
                    <input type="text" name="stk" value="'.$row["stk"].'" class="form-control input-number" id="inputAddress" placeholder="8019385039850">
                  </div>
                  </div>
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-4">
                      ...
                      <select id="inputState" name="ch1" class="form-control">
                        <option value="'.$row["ch1"].'" selected>'.$row["ch1"].'</option>
            ...
            <option value="Vợ (chồng) bạn học trường trung học nào?">Vợ (chồng) bạn học trường trung học nào?</option>
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <select id="inputState" name="ch2" class="form-control">
                        <option value="'.$row["ch2"].'" selected>'.$row["ch2"].'</option>
                        <option value="Bà ngoại của bạn được sinh ra tại thành phố nào?">Bà ngoại của bạn được sinh ra tại thành phố nào?</option>
            <option value="Bà nội của bạn được sinh ra tại thành phố nào?">Bà nội của bạn được sinh ra tại thành phố nào?</option>
            <option value="Bạn đã gặp người hôn phối của bạn vào năm nào (NNNN)?">Bạn đã gặp người hôn phối của bạn vào năm nào (NNNN)?</option>
            <option value="Bạn đi nghỉ tuần trăng mật của mình ớ thị trấn nào?">Bạn đi nghỉ tuần trăng mật của mình ớ thị trấn nào?</option>
            ...
            <option value="Vợ (chồng) bạn học trường trung học nào?">Vợ (chồng) bạn học trường trung học nào?</option>
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <select id="inputState" name="ch3" class="form-control">
                        <option value="'.$row["ch3"].'" selected>'.$row["ch3"].'</option>
                        <option value="Bà ngoại của bạn được sinh ra tại thành phố nào?">Bà ngoại của bạn được sinh ra tại thành phố nào?</option>
            <option value="Bà nội của bạn được sinh ra tại thành phố nào?">Bà nội của bạn được sinh ra tại thành phố nào?</option>
            <option value="Bạn đã gặp người hôn phối của bạn vào năm nào (NNNN)?">Bạn đã gặp người hôn phối của bạn vào năm nào (NNNN)?</option>
            <option value="Bạn đi nghỉ tuần trăng mật của mình ớ thị trấn nào?">Bạn đi nghỉ tuần trăng mật của mình ớ thị trấn nào?</option>
            ...
            <option value="Vợ (chồng) bạn học trường trung học nào?">Vợ (chồng) bạn học trường trung học nào?</option>
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="tl1" class="form-control input-phone" id="inputAddress" value="'.$row["tl1"].'" >
                  </div>
                  <div class="form-group col-md-4">
                    
                    <input type="text" name="tl2" class="form-control input-number" id="inputAddress" value="'.$row["tl2"].'">
                  </div>
                  <div class="form-group col-md-4">
                    
                    <input type="text" name="tl3" class="form-control input-number" id="inputAddress" value="'.$row["tl3"].'">
                  </div>
                  </div>
                  <div class="form-row">
                    <div class="form-group col-md-4">
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-4">
                      ...
                      <input type="text" name="routing" class="form-control input-number" id="inputAddress" value="'.$row["routing"].'">
                    </div>
                    <div class="form-group col-md-4">
                      <label for="inputState">Account number *</label>
                      <input type="text" name="accountnumber" class="form-control input-number" id="inputAddress" value="'.$row["accountnumber"].'">
                    </div>
                    <div class="form-group col-md-4">
                      <label for="inputState">Beneficiary name *</label>
                      <input type="text" name="beneficiaryname" class="form-control input-number" id="inputAddress" value="'.$row["beneficiaryname"].'">
                    </div>
                  </div>
