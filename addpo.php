<?php
   if (isset($_POST["submit"]))
   {
       ...
       if ($_FILES['fileupload']['size'] != 0)
       {
           ...
           $sql = "INSERT INTO `po` (`id`, `email`, `password`, `emailkp`, `passwordpo`, `phone`, `cccd`, `stk`, `ch1`, `ch2`, `ch3`, `tl1`, `tl2`, `tl3`, `bankname`, `bankaddress`, `accounttype`, `routing`, `accountnumber`, `beneficiaryname`, `active`, `img`) VALUES (NULL, '" . $email . "', '" . $password . "', '" . $emailkp . "', '" . $passwordpo . "', '" . $phone . "', '" . $cccd . "', '" . $stk . "', '" . $ch1 . "', '" . $ch2 . "', '" . $ch3 . "', '" . $tl1 . "', '" . $tl2 . "', '" . $tl3 . "', '" . $bankname . "', '" . $bankaddress . "', '" . $accounttype . "', '" . $routing . "', '" . $accountnumber . "', '" . $beneficiaryname . "', '" . $active . "', '" . $target_file . "')";
       ...
       else
       {
           ...
           $sql = "INSERT INTO `po` (`id`, `email`, `password`, `emailkp`, `passwordpo`, `phone`, `cccd`,  `stk`, `ch1`, `ch2`, `ch3`, `tl1`, `tl2`, `tl3`, `bankname`, `bankaddress`, `accounttype`, `routing`, `accountnumber`, `beneficiaryname`, `active`, `img`) VALUES (NULL, '" . $email . "', '" . $password . "', '" . $emailkp . "', '" . $passwordpo . "', '" . $phone . "', '" . $cccd . "', '" . $stk . "', '" . $ch1 . "', '" . $ch2 . "', '" . $ch3 . "', '" . $tl1 . "', '" . $tl2 . "', '" . $tl3 . "', '" . $bankname . "', '" . $bankaddress . "', '" . $accounttype . "', '" . $routing . "', '" . $accountnumber . "', '" . $beneficiaryname . "', '" . $active . "', '')";
           if (mysqli_query($conn, $sql))
           {
               header('Location: addpo.php');
           }
...
<main role="main" class="main-content">
   <div class="container-fluid">
      <div class="row justify-content-center">
         <div class="col-12">
            <h2 class="page-title">Form Add PO</h2>
                  ...
                  <div class="card-deck">
                     <div class="card shadow mb-4">
                        <div class="card-header">
                           <strong class="card-title">Add PO</strong>
                        </div>
                        <div class="card-body">
                           <form method="post" enctype="multipart/form-data" action="">
                              ...
                              <div class="form-row">
                                 <div class="form-group col-md-6">
                                    ...
                                    <input type="email" name="emailkp" class="form-control" id="inputEmail4" placeholder="Email">
                                 </div>
                                 <div class="form-group col-md-6">
                                    <label for="inputPassword4">Password PO *</label>
                                    <input type="password" name="passwordpo" class="form-control" id="inputPassword4" placeholder="Password">
                                 </div>
                              </div>
                              <div class="form-row">
                                 <div class="form-group col-md-4">
                                    <label for="inputPhoneUS">Phone *</label>
                                    <input type="text" name="phone" class="form-control input-phone" id="inputAddress" placeholder="(124) 035-6451">
                                 </div>
                                 <div class="form-group col-md-4">
                                    <label for="inputPhoneUS">CCCD *</label>
                                    <input type="text" name="cccd" class="form-control input-number" id="inputAddress" placeholder="033177000374">
                                 </div>
                                 <div class="form-group col-md-4">
                                    <label for="inputNumber">STK *</label>
                                    <input type="text" name="stk" class="form-control input-number" id="inputAddress" placeholder="8019385039850">
                                 </div>
                              </div>
                              <div class="form-row">
                                 <div class="form-group col-md-4">
                                    ...
                                    <select id="inputState" name="ch1" class="form-control">
                                       ...
                                       <option value="Lần đầu tiên bạn ra nước ngoài lúc mây tuổi? (ví dụ">Lần đầu tiên bạn ra nước ngoài lúc mây tuổi?</option>
                                       <option value="Mẹ bạn sinh ra ở thị trấn nào?">Mẹ bạn sinh ra ở thị trấn nào?</option>
                                       <option value="Mẹ của bạn bao nhiêu tuổi khi bạn được sinh ra? (ví dụ">Mẹ của bạn bao nhiêu tuổi khi bạn được sinh ra?</option>
                                       <option value="Moldel xe ô tô đầu tiên? (ví dụ">Moldel xe ô tô đầu tiên?</option>
                              ...
                              <div class="form-row">
                                 <div class="form-group col-md-4">
                                    <input type="text" name="tl1" class="form-control input-phone" id="inputAddress" placeholder="Nhập câu trả lời">
                                 </div>
                                 <div class="form-group col-md-4">
                                    <input type="text" name="tl2" class="form-control input-number" id="inputAddress" placeholder="Nhập câu trả lời">
                                 </div>
                                 <div class="form-group col-md-4">
                                    <input type="text" name="tl3" class="form-control input-number" id="inputAddress" placeholder="Nhập câu trả lời">
                                 </div>
                              </div>
                              <div class="form-row">
                                 <div class="form-group col-md-4">
                              ...
                              <div class="form-row">
                                 <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="routing" class="form-control input-number" value="061120084" id="inputAddress" placeholder="061120084">
                                 </div>
                                 <div class="form-group col-md-4">
                                    <label for="inputState">Account number *</label>
                                    <input type="text" name="accountnumber" class="form-control input-number" id="inputAddress" value="" placeholder="4022635012586">
                                 </div>
                                 <div class="form-group col-md-4">
                                    <label for="inputState">Beneficiary name *</label>
                                    <input type="text" name="beneficiaryname" class="form-control input-number" id="inputAddress" value="" placeholder="An My Le">
                                 </div>
                              </div>
                              ...
                              <div class="form-group">
                                 <div class="form-check">
                                    <div class="custom-control custom-switch">
                                       <input type="checkbox" name="used" class="custom-control-input" id="c5" >
