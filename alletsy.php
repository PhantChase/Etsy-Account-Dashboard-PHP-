                    ...
                    <div class="card-body">
                      ...
                      <th>VPS</th>
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT * FROM `etsy` ORDER BY id DESC ";
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    echo '
					                  <tr>
                                        ...
                                        $row["id"] .
                                        '</th>
					                    <td><a href="editetsy.php?etsyname='.$row["etsyname"].'" ><i class="fe fe-eye fe-16"></i></a></td>
                              ...
                              <td><a href="htmldom.php?shopname='.$row["etsyname"].'" onclick="';
                                    echo "CopyToClipboard('ccnumber" . $row["id"] . "')";
                                    echo ';return false;"><i class="fe fe-copy fe-16"></i></a></td>
					                    <td id="exdate'.$row["id"].'">';
					                    $sqlinfo = "SELECT * FROM `info` WHERE id='".$row["info"]."'";
                                    ...
                                    echo '
					                    ...
					                    <td id="ccv'.$row["id"].'">';
					                    $sqlpo = "SELECT * FROM `po` WHERE id='".$row["po"]."'";
					                ...
					                echo '
					                    ...
					                    <td id="'.$row["cc"].'">';
                              $sqlcc = "SELECT * FROM `cc` WHERE id='".$row["cc"]."'";
                                ...
                                while($rowcc = $resultcc->fetch_assoc()) {
                                  echo'<a href="editcc.php?id='.$rowcc["id"].'">';
                                    ...
                                    echo '</td>
					                    ...
					                    <td>';
					                    $sqlvps = "SELECT * FROM `vps` WHERE id='".$row["vps"]."'";
